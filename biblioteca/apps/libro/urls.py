...
urlpatterns = [
    ...
    path('autor/editar_cv/<pk:pk>', AutorUpdate.as_view(), name='autor_editar_c'),
    path('autor/eliminar_cv/<pk:pk>',
    ...
    path('autor/editar_fv/<pk:pk>', autor_update, name='autor_editar_f'),
    path('autor/eliminar_fv/<pk:autor_id>',
    ...
    path('libro/editar_cv/<pk:pk>', LibroEdit.as_view(), name='libro_editar_c'),
    path('libro/eliminar_cv/<pk:pk>',
    ...
    path('libro/editar_fv/<pk:id_libro>', libro_update, name='libro_editar_f'),
    path('libro/eliminar_fv/<pk:id_libro>',
